  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <button className="pointer-events-auto bg-brand-dark text-white px-8 py-4 rounded-full shadow-2xl flex items-center gap-3 hover:bg-brand-gold transition-colors duration-300 group">
