      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2">
            <span className="text-brand-gold uppercase tracking-widest text-xs font-bold mb-6 block">
              Meet Your Sculptor
            </span>
            <h2 className="text-5xl font-serif mb-8 leading-snug">
            ...
            <div className="space-y-6 text-brand-muted leading-relaxed">
              <p>
                Hi, I'm Herlinda Grill. My passion for body sculpting goes beyond aesthetics.
            ...
            <div className="mt-12 p-8 bg-white rounded-3xl border border-brand-gold/10">
              ...
              <p className="text-sm text-brand-muted">
                Located in a private studio in Santa Ana, CA. To maintain an exclusive VIP experience,
